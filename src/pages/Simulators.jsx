    ...
    <div className="placeholder-page">
      <section className="video-highlight container" style={{ paddingTop: '100px' }}>
        <VideoSection
          ...
          title={t('sim.video.title')}
          description={t('sim.video.desc')}
          reverse={false}
        />
      </section>
      ...
      <section className="catalog-grid-section container" style={{ marginTop: '4rem' }}>
        <div className="section-header">
          <h2 className="section-title">{t('sim.productsTitle')}</h2>
      ...
      <section className="cta-section container">
        <div className="cta-content">
          <h2>{t('sim.cta.title')}</h2>
          <p>{t('sim.cta.desc')}</p>
          <a href="/iletisim" className="btn-cta">{t('sim.cta.btn')}</a>
        </div>
      </section>
    </div>
  );
